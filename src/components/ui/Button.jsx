...
export function Button({ 
  ...
  const variants = {
    primary: 'bg-primary text-bg shadow-[0_4px_20px_rgba(0,255,136,0.2)] hover:shadow-[0_12px_30px_rgba(0,255,136,0.45)] hover:-translate-y-1 hover:scale-[1.02] border border-primary/20',
